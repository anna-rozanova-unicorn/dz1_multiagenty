...
public class TripletTests {
    ...
    @BeforeEach
    void beforeEach() {
        tQueue = new TripletDeque<>(); // Инициализируем tQueue
        cQueue = (Containerable) tQueue; // Приведение tQueue к Containerable
        tQueue.clear(); // Чистим deque перед каждым тестом
    }
